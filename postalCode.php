...
<head>
    ...
    <script src="/WEB-APP/assets/js/search.js"></script>
...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="javascript:void(0)">
                <img src="/WEB-APP/assets/img/online-registration.png" height="30">
            </a>
    ...
    <div class="container">
        ...
        <div class="card mt-3">
            ...
            <form action="/WEB-APP/models/save-postal-code.php" method="POST">
...
<script>
    function display_province(regCode){
        $.ajax({
        url: '/WEB-APP/models/ph_address.php',
        type: 'POST',
        data: { 
            'type': 'region',
            'post_code': regCode
